          ...
          {blog?.title?.rendered}
            ...
            <Box className="singlepage-section2">
              ...
              <Box className="logo" width={280} display={'flex'} alignItems={'center'} justifyContent={'space-between'} marginTop={4} >
                <a target='_blank' href="https://www.facebook.com/sohamsolution/"> <img height={36} src={Facebook} alt="" /></a>
                {/* <a target='_blank' href="https://x.com/i/flow/login?redirect_after_login=%2Fsoham_web"> <img height={30} src={Twitter} alt="" /></a> */}
                <a target='_blank' href="https://www.pinterest.com/pin/create/button/?url=https://sohamsolution.com/9-steps-to-creating-a-wordpress-plugin/&description=9%20Steps%20to%20Creating%20a%20WordPress%20Plugin%20for%20Beginners">  <img height={30} src={Pintrest} alt="" /></a>
                ...
                <a target='_blank' href="https://www.tumblr.com/widgets/share/tool/preview?shareSource=legacy&canonicalUrl=&url=https%3A%2F%2Fsohamsolution.com%2F9-steps-to-creating-a-wordpress-plugin%2F&posttype=link&title=9+Steps+to+Creating+a+WordPress+Plugin+for+Beginners&caption=A+WordPress+plugin+is+a+software+that+can+be+added+to+a+WordPress+website+to+enhance+its+functionality+and+add+new+features.+It+acts+as+an+add-on%2C+eliminating+the+need+for+coding+or+technical+knowledge.+Plugins+are+created+by+developers+and+can+be+downloaded+from+the+WordPress+plugin+directory+or+third-party+websites.&content=https%3A%2F%2Fsohamsolution.com%2F9-steps-to-creating-a-wordpress-plugin%2F"><img height={30} src={Blckt} alt="" /></a>
                <a target='_blank' href="https://www.youtube.com/@SohamWebSolutionDewas"> <img height={30} src={Youtuve} alt="" /></a>
                <a target='_blank' href="https://profiles.wordpress.org/sohamwebsolution/"> <img height={30} src={Wordpress} alt="" /></a>
              </Box>
            </Box>
          </Box>
