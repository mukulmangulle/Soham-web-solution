    ...
    return (
        <>
            <Box className="flex-center bg-img  " >
                <Typography variant='h2' className='primary-heading'> Terms & Conditions </Typography>
            </Box>
            <Box className=" flex-center padding-top-bottom" >

                <Box className="flex-center-column privacy_man"  >
                    <Typography className='terms_conditon_heading'>Last updated on 22-11-2023 09:56:51</Typography>
                    <Typography className="terms_conditon_content">These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between Soham Web Solution, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).</Typography>

                    <Typography className="terms_conditon_content">By using our website and availing the Services, you agree that you have read and accepted these Terms (including the Privacy Policy). We reserve the right to modify these Terms at any time and without assigning any reason. It is your responsibility to periodically review these Terms to stay informed of updates.</Typography>

                    <Typography className="terms_conditon_content">The use of this website or availing of our Services is subject to the following terms of use:</Typography>
                    ...
                    <ul className="terms_conditon_content">
                        ...
                        <li>You shall be entitled to claim a refund of the payment made by you in case we are not able to provide the Service. The timelines for such return and refund will be according to the specific <br></br>
                            Service you have availed or within the time period provided in our policies (as applicable). In case you do not raise a refund claim within the stipulated time, than this would make you ineligible for a refund.
                        </li>
